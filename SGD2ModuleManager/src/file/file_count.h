...
#ifndef SGD2MODULEMANAGER_FILE_FILE_COUNT_H_
#define SGD2MODULEMANAGER_FILE_FILE_COUNT_H_
...
size_t File_CountFromDirectory(
...
#endif /* SGD2MODULEMANAGER_FILE_FILE_COUNT_H_ */
