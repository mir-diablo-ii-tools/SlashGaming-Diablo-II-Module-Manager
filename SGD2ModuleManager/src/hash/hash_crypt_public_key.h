...
#ifndef SGD2MODULEMANAGER_HASH_HASH_CRYPT_PUBLIC_KEY_H_
#define SGD2MODULEMANAGER_HASH_HASH_CRYPT_PUBLIC_KEY_H_
...
#endif /* SGD2MODULEMANAGER_HASH_HASH_CRYPT_PUBLIC_KEY_H_ */
